# Builds the production web app using values from the root .env file.
#
#   .\scripts\build_production.ps1
#
# The publishable key is public by design: it is embedded in the deployed web
# build. Never put a Supabase service_role key in .env or in --dart-define.
